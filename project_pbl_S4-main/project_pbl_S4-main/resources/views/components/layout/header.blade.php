    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-container container-fluid">
            <ul class="nav-left">
                ...
                <li>                   
                    <span class="btn btn-inverse btn-mat"><a href="{{url('Home')}}"  style="color:white">Pergi ke Halaman Pengguna</a> </span>
                </li>
            </ul>
            <ul class="nav-right">
                ...
                <li class="user-profile header-notification">
                    <div class="dropdown-primary dropdown">
                        <div class="dropdown-toggle" data-toggle="dropdown">
                            <img src="{{asset(auth()->user()->foto_profil)}}" class="img-radius"
